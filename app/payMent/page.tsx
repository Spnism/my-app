...
export default function PaymentPage() {
  ...
  const styles: Record<string, any> = {
    ...
    sectionTitle: { fontSize: 24, fontWeight: 700, marginBottom: 15 },
    row: { display: 'flex', justifyContent: 'space-between', marginBottom: 10 },
    total: { fontSize: 28, fontWeight: 900, color: '#B22222' },
    payBtn: {
      marginTop: 30,
      background: '#B22222',
      color: '#fff',
    ...
    qr: { width: 120, height: 120, background: '#000', borderRadius: 12 },
    bankIcon: { width: 120, height: 80, background: '#000', borderRadius: 8 },
  };
